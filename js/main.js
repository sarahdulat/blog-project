...
$('document').ready(function() {
	...
	var post = [{
		...
		title: "CSS + Terminal",
		date: new Date("February 10 2016"),
		imgSrc: "",
		...
		if (post.date) {
		$post.append($('post.date'));
	}
		if (post.imgSrc) {
		$post.append($('<img src="' + post.imgSrc + '" />'));
	}
		if (post.copy) {
